...
export default function MainPage() {
  ...
  // Separate box states for each tab
  ...
  // Function to add boxes according to active tab
  const handleAddBox = () => {
  ...
  const handleTextChange = (index, event) => {
    // To update the content of the textarea
  ...
  return (
    ...
    <div className="main-page">
      ...
      <div className="bottom">
        ...
        <div className="songInfo">{/* Song name here */}</div>
      </div>
      </div>
    </>
  );
